...
function loadSounds() {
    _soundmanager.soundManager.setup({
        ...
        onready: function onready() {
            return _sounds2.default.forEach(loadSound);
        }
    });
}
...
function loadSound(sound) {
    ...
    _soundmanager.soundManager.createSound({
        id: sound.name,
        ...
        onload: function onload() {
            ...
            button.onclick = function () {
                ...
                _soundmanager.soundManager.getSoundById(sound.name).play();
            };
        },
        onplay: function onplay() {
            return button.classList.add("fade");
        },
        onstop: function onstop() {
            return button.classList.remove("fade");
        },
    ...
    setTimeout(function () {
        return _soundmanager.soundManager.getSoundById(sound.name).load();
    }, Math.random() * 10000);
}
...
},{"./sounds":3,"soundmanager2":1}],3:[function(require,module,exports){
"use strict";
...
exports.default = [{
    ...
    name: "Dr Who",
    file: "Doctor Who Theme Tune 1963-1969.mp4"
}, {
    name: "Future 7",
    file: "dystopian-future-fx-sounds-7.wav"
}, {
    name: "Future 22",
    file: "dystopian-future-fx-sounds-22.wav"
}, {
    name: "Electro",
    file: "electronic-future-loop.mp3"
}, {
    name: "Future Cymbals",
    file: "exotic-future-phasing-splash-cymbal.wav"
}, {
    name: "Fight",
    file: "fight2.mp3"
}, {
    ...
    name: "Future Car",
    file: "future-car-001-or-spaceship.wav"
}, {
    name: "Future Thunder",
    file: "future-thunder1.wav"
}, {
    name: "Future Garage",
    file: "futuregarage-loop1.wav"
}, {
    name: "Haunting",
    file: "haunting-music.wav"
}, {
    name: "Hyena",
    ...
    name: "BEAM ME UP",
    file: "old-style-teleport-2.wav"
}, {
    name: "Future Echoes",
    file: "future-echoes-and-echoes-from-the-future.flac"
}, {
    name: "Future Alarm",
    file: "sci-fi-alarm.wav"
}];
